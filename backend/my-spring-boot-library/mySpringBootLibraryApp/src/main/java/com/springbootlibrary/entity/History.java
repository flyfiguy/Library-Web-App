...
public class History {
    ...
    public History(Long id, String userEmail, String checkoutDate, String returnedDate, String title,
    ...
    public History(String userEmail, String checkoutDate, String returnedDate, String title,
                   String author, String description, String img) {
        //id is not here since the value is autogenerated by the database.
        this.userEmail = userEmail;
        this.checkoutDate = checkoutDate;
        this.returnedDate = returnedDate;
        this.title = title;
