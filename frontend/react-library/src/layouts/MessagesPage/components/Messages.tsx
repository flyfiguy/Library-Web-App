    ...
    useEffect(() => {
        const fetchUserMessages = async () => {
            if(authState && authState?.isAuthenticated){
                ...
                const messagesResponsJson = await messagesResponse.json();
                setMessages(messagesResponsJson._embedded.messages);
                setTotalPages(messagesResponsJson.page.totalPages);
            }
