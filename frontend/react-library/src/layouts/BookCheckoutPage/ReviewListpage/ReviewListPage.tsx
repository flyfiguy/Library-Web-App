...
export const ReviewListPage = () => {
    ...
    //Get book id to lookup reviews for from the URL for this page.
    //window.location.pathname: Returns the Location object's URL's path.
    ...
    useEffect(()=>{
        const fetchBookReviews = async () => {
            ...
            if(!responseReviews.ok){
                throw new Error('Something went wrong with fetch for fetch book reviews in ReviewListPage!');
            }
